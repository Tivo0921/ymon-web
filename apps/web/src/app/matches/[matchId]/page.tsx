        ...
        return (
            <main style={{
                ...
                <div style={{ maxWidth: 900, margin: "0 auto", padding: 24 }}>
                    ...
                    <h2 style={{ color: "white" }}>match data</h2>
                    <pre style={{ background: "#111", color: "white", padding: 12, overflowX: "auto", fontSize: 12 }}>
                        {JSON.stringify(matchData, null, 2)}
                    </pre>

                    <h2 style={{ color: "white" }}>自分の所持教授（3体選択）</h2>
                    {!handle && <p style={{ color: "white" }}>※ handle 付きで遷移していないので所持教授が取れない。</p>}
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 8 }}>
                        {owned.map((o) => {
                            ...
                            return (
                                <label key={k} style={{ border: "1px solid #ddd", padding: 10, borderRadius: 8, background: "rgba(255, 255, 255, 0.8)", color: "black" }}>
                    ...
                    <p style={{ color: "white", marginTop: 12 }}>選択中: {p1Keys.join(", ") || "(none)"}</p>

                    <div style={{ display: "flex", gap: 8, marginTop: 12 }}>
                        <button
                            onClick={startBattle}
                            disabled={isStartingBattle}
                            style={{ padding: 16, fontSize: 18, background: "rgba(255, 255, 255, 0.85)", color: "black", border: "none", borderRadius: 4, opacity: isStartingBattle ? 0.5 : 1, cursor: isStartingBattle ? "not-allowed" : "pointer", fontWeight: "bold", flex: 1 }}
                        >
                            {isStartingBattle ? "battle start中..." : "battle start"}
                        </button>
                        <button onClick={load} style={{ padding: 16, fontSize: 18, background: "rgba(255, 255, 255, 0.85)", color: "black", border: "none", borderRadius: 4, fontWeight: "bold", flex: 1 }}>reload</button>
                    </div>
                </div>
            </main>
        );
    ...
    return (
        <main style={{
            ...
            <div style={{ maxWidth: 900, margin: "0 auto", padding: 24 }}>
                ...
                {battleState && (
                    <>
                        <h2 style={{ color: "white" }}>Team Status</h2>
                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 16 }}>
                            {/* P1 Team */}
                            <div style={{ border: "1px solid blue", padding: 12, background: "rgba(255, 255, 255, 0.9)", borderRadius: 4 }}>
                                <h3 style={{ color: "black" }}>P1 Team</h3>
                                {battleState.p1Team.map((prof, idx) => (
                                    <div
                                        ...
                                        style={{
                                            marginBottom: 8,
                                            padding: 8,
                                            background: idx === battleState.p1ActiveIndex ? "#e3f2fd" : "transparent",
                                            borderRadius: 4,
                            ...
                            {/* P2 Team */}
                            <div style={{ border: "1px solid red", padding: 12, background: "rgba(255, 255, 255, 0.9)", borderRadius: 4 }}>
                                <h3 style={{ color: "black" }}>P2 Team</h3>
                                {battleState.p2Team.map((prof, idx) => (
                                    <div
                                        ...
                                        style={{
                                            marginBottom: 8,
                                            padding: 8,
                                            background: idx === battleState.p2ActiveIndex ? "#ffebee" : "transparent",
                                            borderRadius: 4,
                                            opacity: prof.cur_hp <= 0 ? 0.5 : 1,
                                            color: "black"
                                        }}
